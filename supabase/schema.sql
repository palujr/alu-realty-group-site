...
create table if not exists public.broker_sites (
  ...
  idx_provider_name text,
  idx_embed_url text,
  idx_embed_code text,
  idx_search_url text,
  idx_fallback_message text,
  brand_primary text,
  brand_accent text,
...
on conflict (slug) do update set
  ...
  footer_logo_display = excluded.footer_logo_display,
  fair_housing_logo_url = excluded.fair_housing_logo_url,
  fair_housing_text = excluded.fair_housing_text,
  fair_housing_show_text = excluded.fair_housing_show_text,
  realtor_logo_url = excluded.realtor_logo_url,
  ...
  idx_enabled = excluded.idx_enabled,
  idx_provider_name = excluded.idx_provider_name,
  idx_embed_url = excluded.idx_embed_url,
  idx_embed_code = excluded.idx_embed_code,
  idx_search_url = excluded.idx_search_url,
  idx_fallback_message = excluded.idx_fallback_message,
